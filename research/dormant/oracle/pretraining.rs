...
impl CodeEncoder {
    pub fn new(vocab_size: usize, embedding_dim: usize) -> Self {
        Self {
            embedding: Array2::random((vocab_size, embedding_dim), rand::distributions::Standard),
            projection: Array2::random((embedding_dim, embedding_dim), rand::distributions::Standard),
            vocab_size,
            embedding_dim,
        }
    }
