...
impl OracleTrainer {
    ...
    pub fn new(config: OracleConfig, vocab_size: usize) -> Result<Self> {
        ...
        let reference_model = crate::alignment::CodeModel::new(vocab_size, config.training.max_seq_len);
        let current_model = crate::alignment::CodeModel::new(vocab_size, config.training.max_seq_len);
