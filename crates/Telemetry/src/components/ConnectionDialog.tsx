              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    older="http://localhost:8080"
                    disabled={connectionStatus === 'connecting' || connectionStatus === 'connected'}
                    className="flex-1 px-3 py-2 bg-slate-900 border border-slate-700/50 rounded-lg text-xs font-mono text-slate-200 older-slate-600 focus:outline-none focus:border-cyan-500/50 transition-colors disabled:opacity-50"
                  />
                  {connectionStatus === 'connected' ? (
                    <button
