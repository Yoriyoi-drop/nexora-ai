use crate::hallucination::types::PostGenCheckResult;
use regex::Regex;
use std::collections::HashMap;
use std::sync::LazyLock;

#[cfg(feature = "gpu")]
use crate::hallucination::gpu_verifier::gpu_batch_verify;
...
impl PostGenerationVerifier {
    ...
    ) -> Result<PostGenCheckResult, crate::hallucination::HallucinationError> {
