...
impl SpectraCoordinator {
    ...
    fn setup_agent_weights(&mut self) {
        self.inner
            .add_agent_weight("creative_muse".to_string(), 0.3);
        self.inner
            .add_agent_weight("artistic_weaver".to_string(), 0.2);
        self.inner
            .add_agent_weight("style_adapter".to_string(), 0.25);
        self.inner
            .add_agent_weight("innovation_engine".to_string(), 0.25);
    }
    ...
    fn setup_communication_channels(&mut self) {
        ...
        let inspiration_channel = CommunicationChannel {
            ...
            channel_type: nexora_shared::agent_types::ChannelType::Topic("inspiration".to_string()),
            connected_agents: vec!["creative_muse".to_string(), "innovation_engine".to_string()],
            config: HashMap::new(),
        };
        ...
        let style_channel = CommunicationChannel {
            ...
            connected_agents: vec!["artistic_weaver".to_string(), "style_adapter".to_string()],
            config: HashMap::new(),
        };
