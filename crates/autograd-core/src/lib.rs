//! Core autograd operations for Nexora — CPU-only tensor computation.
//!
//! This crate provides the fundamental building blocks:
//! - `Tensor` with tape-based reverse-mode autograd
//! - Common ops (math, matmul, activations, neural network, shape)
//! - Optimizers (`Adam`, `SGD`)
//! - Layer primitives (`Linear`, `MLP`)
//!
//! No GPU dependencies. For GPU-accelerated computation, use `nexora-autograd`.
