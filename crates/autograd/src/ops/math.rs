...
gen_unary_op!(exp,
    ...
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let da = crate::gpu_backward::exp_backward(ctx, &sg[0], gg)
...
gen_unary_op!(ln,
    ...
    Ln, ln,
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let da = crate::gpu_backward::ln_backward(ctx, &sg[0], gg)
...
gen_unary_op!(sqrt,
    ...
    Sqrt, sqrt,
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let da = crate::gpu_backward::sqrt_backward(ctx, &sg[0], gg)
...
gen_unary_op!(neg,
    ...
    move |_sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let da = crate::gpu_backward::neg_backward(ctx, gg)
...
gen_binary_op!(add,
    ...
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        ...
        let (da, db) = crate::gpu_backward::add_backward(ctx, &a_shape, &b_shape, gg)
...
gen_binary_op!(sub,
    ...
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let a_shape = sg[0].shape();
        let b_shape = sg[1].shape();
        let (da, db) = crate::gpu_backward::sub_backward(ctx, &a_shape, &b_shape, gg)
...
gen_binary_op!(mul,
    ...
    mul, mul,
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let (da, db) = crate::gpu_backward::mul_backward(ctx, &sg[0], &sg[1], gg)
...
gen_binary_op!(div,
    ...
    div, div,
    move |sg: &[GpuTensor], gg: &GpuTensor, ctx: &GpuContext| {
        let (da, db) = crate::gpu_backward::div_backward(ctx, &sg[1], &sg[2], gg)
