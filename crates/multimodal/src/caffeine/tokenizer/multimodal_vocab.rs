...
impl MultimodalVocabulary {
    ...
    fn add_basic_vocabulary(
        ...
        let text_words = vec![
            ...
            "below", "between", "among", "under", "over", "hello", "world", "thanks", "please",
            "sorry", "yes", "no", "maybe",
        ];
        ...
        let image_concepts = vec![
            ...
            "bird", "flower", "grass", "rock", "sand", "red", "blue", "green", "yellow", "black",
            "white", "gray", "brown",
        ];
        ...
        let action_concepts = vec![
            "click", "type", "scroll", "drag", "drop", "swipe", "tap", "press", "move", "stop",
            "start", "pause", "resume", "cancel", "confirm", "submit", "open", "close", "save",
            "load", "delete", "copy", "paste", "cut", "undo", "redo", "search", "find", "replace",
            "select", "deselect",
        ];
