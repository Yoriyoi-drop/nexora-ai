...
impl CheckpointUtils {
    ...
    pub fn restore_from_checkpoint(
        ...
        model.load_parameters(
            &checkpoint.model_state.parameters,
            &checkpoint.model_state.shapes,
        )?;
    ...
    pub fn compare_checkpoints(
        ...
        CheckpointComparison {
            ...
            learning_rate_diff: checkpoint2.metrics.learning_rate
                - checkpoint1.metrics.learning_rate,
        }
    }
}
