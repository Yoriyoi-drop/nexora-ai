...
use crate::multimodal::cache::{CacheConfig, MultiModalCache};
...
pub struct MultiModalEncoders {
    ...
    config: crate::multimodal::config::EncodersConfig,
}

impl MultiModalEncoders {
    /// Create new multi-modal encoders
    pub fn new(config: crate::multimodal::config::EncodersConfig) -> Result<Self> {
