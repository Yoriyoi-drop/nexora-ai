...
pub struct AudioEncoder {
    config: crate::multimodal::config::AudioEncoderConfig,
    model_loaded: bool,
    sample_rate: usize,
    n_mels: usize,
...
impl AudioEncoder {
    ...
    pub fn new(config: crate::multimodal::config::AudioEncoderConfig) -> Result<Self> {
    ...
    /// Get configuration
    pub fn config(&self) -> &crate::multimodal::config::AudioEncoderConfig {
        &self.config
    }
