...
pub struct TextEncoder {
    config: crate::multimodal::config::TextEncoderConfig,
    model_loaded: bool,
    vocab_size: usize,
...
impl TextEncoder {
    ...
    pub fn new(config: crate::multimodal::config::TextEncoderConfig) -> Result<Self> {
    ...
    /// Get configuration
    pub fn config(&self) -> &crate::multimodal::config::TextEncoderConfig {
        &self.config
    }
