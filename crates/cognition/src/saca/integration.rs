...
impl SACAIntegration {
    ...
    async fn apply_caffeine_enhancement(
        ...
        let multimodal_inputs = crate::multimodal::types::MultiModalInputs {
            text: Some(crate::multimodal::types::TextInput {
            ...
            audio: None,
            video: None,
            context: Some(crate::multimodal::types::ContextInfo {
                task_type: crate::multimodal::types::TaskType::Generation,
...
impl SACAFactory {
    ...
    pub async fn create_full_saca(
        ...
        caffeine_config: Option<crate::multimodal::config::CaffeineConfig>,
    ...
    pub async fn create_saca_with_caffeine(
        saca_config: SACAConfig,
        caffeine_config: crate::multimodal::config::CaffeineConfig,
    ) -> SACAResult<SACAIntegration> {
        let caffeine = Arc::new(Mutex::new(Caffeine::new(caffeine_config).map_err(|e| {
            SACAError::ContextError(format!("Caffeine creation failed: {}", e))
        })?));
