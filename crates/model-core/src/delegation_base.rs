use crate::foundation::FoundationModel;
use ndarray::Array2;
...
pub fn embed_average(embed_table: &Array2<f32>, token_ids: &[u32]) -> Vec<f32> {
    crate::classifier_util::embed_average(embed_table, token_ids).to_vec()
}

pub fn sanitize_prompt(prompt: &str) -> String {
    crate::classifier_util::sanitize_prompt(prompt)
}
...
pub async fn call_model(
    ...
    crate::foundation::call_model(f, prompt, max_tokens, temperature).await
}
