...
use crate::{HallucinationError, PostGenCheckResult};
...
pub fn gpu_batch_verify(
    ...
    let gpu_sent = nexora_autograd::gpu::GpuTensor::from_cpu(&sent_features.into_dyn())
        .map_err(|e| HallucinationError::Internal(e.to_string()))?;
    let gpu_src = nexora_autograd::gpu::GpuTensor::from_cpu(&src_features.into_dyn())
        .map_err(|e| HallucinationError::Internal(e.to_string()))?;
