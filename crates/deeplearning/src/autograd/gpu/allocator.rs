...
impl GpuContext {
    ...
    ) -> crate::autograd::gpu_memory::PooledBuffer {
        self.memory_pool
            .lock()
            .unwrap_or_else(|e| {
    ...
    pub fn dealloc_buffer(&self, buf: crate::autograd::gpu_memory::PooledBuffer) {
        self.memory_pool
            .lock()
            .unwrap_or_else(|e| {
                tracing::warn!("Lock poisoned: {}", e);
    ...
    pub fn memory_stats(&self) -> crate::autograd::gpu_memory::PoolStats {
        self.memory_pool
            .lock()
            .unwrap_or_else(|e| {
                tracing::warn!("Lock poisoned: {}", e);
