...
use crate::autograd::gpu_caps::GpuCapabilities;
...
pub struct GpuContext {
    ...
    /// Uses `std::sync::Mutex` — all GPU dispatch methods are sync. Never used in async context.
    pub(crate) memory_pool: Mutex<crate::autograd::gpu_memory::GpuMemoryPool>,
    /// Unified memory coordinator — tracks pool + external allocations.
    pub(crate) _memory_coordinator: Mutex<crate::autograd::gpu_memory::MemoryCoordinator>,
    ...
    pub(crate) disk_cache: Option<crate::autograd::persistent_cache::PipelineDiskCache>,
    ...
    #[cfg(feature = "cuda")]
    pub(crate) cuda: Option<&'static crate::autograd::gpu::cuda::CudaRuntime>,
...
impl GpuContext {
    ...
    #[cfg(feature = "cuda")]
    pub fn cuda_runtime(&self) -> Option<&'static crate::autograd::gpu::cuda::CudaRuntime> {
        self.cuda
    }
}
