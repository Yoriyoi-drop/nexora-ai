...
impl GpuTensor {
    ...
    pub fn to_cpu_async(
        &self,
        ctx: &GpuContext,
    ) -> Result<crate::autograd::gpu_async::AsyncReadback<Vec<f32>>, GpuError> {
    ...
    pub fn to_cpu_raw_bytes_async(
        &self,
        ctx: &GpuContext,
    ) -> Result<crate::autograd::gpu_async::AsyncReadback<Vec<u8>>, GpuError> {
        let byte_size = (self.numel() * self.dtype.byte_size()) as u64;
        ...
        Ok(crate::autograd::gpu_async::AsyncReadback::new(rx, ready))
    }
