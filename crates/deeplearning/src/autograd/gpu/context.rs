...
impl GpuContext {
    ...
    pub(crate) async fn from_adapter(adapter: wgpu::Adapter) -> Result<Self, GpuError> {
        ...
        let memory_pool = Mutex::new(crate::autograd::gpu_memory::GpuMemoryPool::new(&device));
        ...
        let disk_cache = crate::autograd::persistent_cache::PipelineDiskCache::new();
        ...
        #[cfg(feature = "cuda")]
        let cuda_runtime = crate::autograd::gpu::cuda::CudaRuntime::try_init();
        #[cfg(feature = "cuda")]
        ...
        let mut ctx = Self {
            ...
            _query_resolve_buf: None,
            _query_readback_buf: None,
