...
#[cfg(feature = "serde")]
use crate::autograd::LossScaler;
use crate::autograd::{Adam, Tensor};
...
pub struct TrainingLoop {
    ...
    pub checkpoint_callback: Option<Box<dyn Fn(u64) -> crate::autograd::DLResult<()> + Send>>,
...
impl TrainingLoop {
    ...
    where
        F: Fn(u64) -> crate::autograd::DLResult<()> + Send + 'static,
    {
                ...
                if let Err(e) = std::fs::create_dir_all(dir) {
                    ...
                    #[cfg(feature = "serde")]
                    {
                        let params = self.params.as_ref().ok_or_else(|| {
                            crate::autograd::DeepLearningError::Computation {
...
mod tests {
    use super::*;
    use crate::autograd::{Linear, Module, Tensor, TensorOps};
