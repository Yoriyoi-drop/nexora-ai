...
impl EchoNetModel {
    pub fn new(config: EchoNetConfig) -> DLResult<Self> {
        ...
        let bands: Vec<crate::echo_net::FrequencyBand> = config
            .band_frequencies
            .iter()
            .enumerate()
            .map(|(i, &freq)| crate::echo_net::FrequencyBand {
                id: i,
        ...
        let levels: Vec<crate::echo_net::CompressionLevel> = (0..config.compression_levels)
            .map(|i| crate::echo_net::CompressionLevel {
                level: i,
        ...
        let isc_cfg = crate::echo_net::SpectralCollapseConfig {
            output_size,
            temperature: 1.0,
