...
impl ShapePropagator {
    ...
    pub fn propagate(
        ...
        if let Some(cached) = self.cache.get(&cache_key) {
            ...
            return Err(crate::gnac::DeepLearningError::ShapeMismatch {
        ...
        match node_type {
            ...
            NodeType::MaxPool | NodeType::AvgPool => {
                ...
                if input.len() == 4 {
                    ...
                    Err(crate::gnac::DeepLearningError::InvalidDimension { dim: input.len() })
                }
            }
            NodeType::Concat => {
                if inputs.len() < 2 {
    ...
    pub fn validate_connection(
        ...
        Err(crate::gnac::DeepLearningError::ShapeMismatch {
