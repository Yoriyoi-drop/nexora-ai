            ...
            if let Some(node) = graph.nodes.get(node_id) {
                ...
                if node.metadata.activation_size == 0 {
                    let suggested = match node.node_type {
                        ...
                        | crate::gnac::NodeType::Conv3D => 4 * 1024 * 1024,
                        crate::gnac::NodeType::SelfAttention
                        | crate::gnac::NodeType::MultiHeadAttention
                        | crate::gnac::NodeType::FlashAttention => 2 * 1024 * 1024,
                        crate::gnac::NodeType::Linear | crate::gnac::NodeType::MatMul => 512 * 1024,
...
pub fn node_type_compute_cost(node_type: &crate::gnac::NodeType) -> usize {
    match node_type {
        ...
        | crate::gnac::NodeType::Tanh => 10_000,
        crate::gnac::NodeType::Softmax => 20_000,
        crate::gnac::NodeType::Embedding => 100_000,
        crate::gnac::NodeType::MambaBlock | crate::gnac::NodeType::StateSpaceModel => 400_000,
        _ => 1_000,
    }
}
