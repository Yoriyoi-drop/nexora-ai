use crate::gnac::canvas::{GraphEdge, GraphNode, ZoomLevel};
...
mod tests {
    ...
    fn simple_graph() -> NeuralGraph {
        ...
        let input = GraphNode::new(crate::gnac::NodeType::Input, "input", -100.0, 0.0);
        let hidden = GraphNode::new(crate::gnac::NodeType::Linear, "hidden", 0.0, 0.0);
        let output = GraphNode::new(crate::gnac::NodeType::Output, "output", 100.0, 0.0);
    ...
    fn test_add_node() {
        ...
        let node = GraphNode::new(crate::gnac::NodeType::Input, "in", 0.0, 0.0);
    ...
    fn test_add_edge_missing_source() {
        let mut g = NeuralGraph::new("g");
        let target = GraphNode::new(crate::gnac::NodeType::Output, "out", 0.0, 0.0);
        let target_id = g.add_node(target);
        let tensor = crate::gnac::TensorDesc::new(vec![1], crate::gnac::DType::F32);
        let e = GraphEdge::new(
            Uuid::new_v4(),
            Uuid::new_v4(),
            target_id,
    ...
    fn test_add_edge_success() {
        let mut g = NeuralGraph::new("g");
        let a = g.add_node(GraphNode::new(crate::gnac::NodeType::Input, "a", 0.0, 0.0));
        let b = g.add_node(GraphNode::new(crate::gnac::NodeType::Linear, "b", 0.0, 0.0));
        let tensor = crate::gnac::TensorDesc::new(vec![1, 64], crate::gnac::DType::F32);
    ...
    fn test_get_input_nodes() {
        ...
        assert_eq!(inputs[0].node_type, crate::gnac::NodeType::Input);
    }
    ...
    fn test_get_output_nodes() {
        ...
        assert_eq!(outputs[0].node_type, crate::gnac::NodeType::Output);
    }

    #[test]
    fn test_get_node_connections() {
        let mut g = NeuralGraph::new("g");
        let inp = GraphNode::new(crate::gnac::NodeType::Input, "in", 0.0, 0.0);
        let mid = GraphNode::new(crate::gnac::NodeType::Linear, "mid", 0.0, 0.0);
        let out = GraphNode::new(crate::gnac::NodeType::Output, "out", 0.0, 0.0);
