...
impl AxiomCapabilities {
    ...
    fn create_capability_vector() -> CapabilityVector {
        CapabilityVector::new(NxrModelId::Axiom)
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Logic, CapabilityLevel::Master)
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Strategy, CapabilityLevel::Expert)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Security, CapabilityLevel::Advanced)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Simulation, CapabilityLevel::Expert)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Decision, CapabilityLevel::Expert)
                    .with_sub_capabilities(vec![
                        "decision optimization".to_string(),
