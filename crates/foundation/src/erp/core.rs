...
impl ResonanceMapper {
    pub fn new(config: ERPConfig) -> Self {
        let projection_method = match config.compression_mode {
            crate::erp::CompressionMode::Conservative => ProjectionMethod::PCA { components: 64 },
            crate::erp::CompressionMode::Balanced => ProjectionMethod::LowRankEmbedding { rank: 32 },
            crate::erp::CompressionMode::Aggressive => ProjectionMethod::RandomProjection { dim: 16 },
        };
