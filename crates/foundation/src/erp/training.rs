...
use crate::erp::{ERPConfig, ERPError, ERPEngine, CompressedLayer};
...
impl ERPTrainer {
    ...
    fn calibrate_layer_gates(&mut self, layer: &mut CompressedLayer, calibration_batch: &CalibrationBatch) -> Result<(), ERPError> {
        let mut reconstructor = crate::erp::reconstruction::ContextReconstructor::new(self.config.clone());
    ...
    fn compute_gate_gradients(&self, layer: &CompressedLayer, input: &Array1<f32>, target: &Array1<f32>, gates: &[crate::erp::reconstruction::GatePattern]) -> Result<Array2<f32>, ERPError> {
    ...
    fn update_gate_weights_from_reconstructor(&self, reconstructor: &mut crate::erp::reconstruction::ContextReconstructor, gradient: &Array2<f32>, learning_rate: f32) -> Result<(), ERPError> {
        // Create a temporary gate network dengan weights dari reconstructor
        let mut temp_gate_network = crate::erp::reconstruction::GateNetwork::new(self.config.clone());
    ...
    /// Compute mapping statistics
    fn compute_mapping_statistics(&self, resonance_groups: &[crate::erp::core::ResonanceGroup], weights: &[Array2<f32>]) -> MappingStatistics {
    ...
    fn estimate_compression_potential(&self, resonance_groups: &[crate::erp::core::ResonanceGroup], weights: &[Array2<f32>]) -> CompressionPotential {
...
pub struct ResonanceMappingResult {
    pub resonance_groups: Vec<crate::erp::core::ResonanceGroup>,
