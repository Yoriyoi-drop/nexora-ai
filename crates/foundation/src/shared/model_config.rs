...
impl Default for NxrModelConfig {
    fn default() -> Self {
        Self {
            model_id: crate::shared::model_identity::NxrModelId::Omnis,
...
impl NxrModelConfig {
    ...
    pub fn for_model(model_id: crate::shared::model_identity::NxrModelId) -> Self {
        let mut config = Self::default();
        config.model_id = model_id;
        
        // Apply model-specific defaults
        match model_id {
            crate::shared::model_identity::NxrModelId::Omnis => {
