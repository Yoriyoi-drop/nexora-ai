        ...
        Self {
            vulnerability_patterns: vec![
                VulnerabilityPattern {
                    ...
                    pattern: Regex::new(r"(?i)execute\s*\(").unwrap(),
                ...
                VulnerabilityPattern {
                    ...
                    pattern: Regex::new(r"(?i)password\s*=").unwrap(),
                    severity: IssueSeverity::Error,
                ...
                VulnerabilityPattern {
                    name: "XSS".to_string(),
                    pattern: Regex::new(r"(?i)(innerHTML|document\.write|eval\s*\()\s*\+").unwrap(),
                    severity: IssueSeverity::Error,
                ...
                VulnerabilityPattern {
                    ...
                    pattern: Regex::new(r"(?i)(\.\.\/|\.\.\\|\/etc\/passwd|\/etc\/shadow)").unwrap(),
                    severity: IssueSeverity::Error,
                ...
                VulnerabilityPattern {
                    ...
                    pattern: Regex::new(r"(?i)(rand|random|Math\.random)\s*\(").unwrap(),
                    severity: IssueSeverity::Warning,
