...
mod tests {
    ...
    #[tokio::test]
    async fn test_saca_full_pipeline() {
        init_logger();
    ...
    #[tokio::test]
    async fn test_saca_with_feedback_loops() {
        init_logger();
    ...
    #[tokio::test]
    async fn test_individual_phases() {
        init_logger();
    ...
    #[tokio::test]
    async fn test_saca_integration() {
        init_logger();
...
mod benchmarks {
    ...
    #[tokio::test]
    async fn benchmark_saca_throughput() {
        super::init_logger();
        let config = SACAConfig::default();
        let saca = SACA::new(config).await.unwrap();
    ...
    #[tokio::test]
    async fn benchmark_phase_performance() {
        super::init_logger();
        let config = SACAConfig::default();
