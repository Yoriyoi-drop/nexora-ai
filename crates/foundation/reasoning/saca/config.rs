...
pub struct SamplingConfig {
    ...
    pub sampling_strategy: crate::saca::types::SamplingStrategy,
...
impl Default for SamplingConfig {
    fn default() -> Self {
        Self {
            num_candidates: 5,
            sampling_strategy: crate::saca::types::SamplingStrategy::Hybrid,
...
pub struct ExecuteConfig {
    pub execution_strategy: crate::saca::types::ExecutionStrategy,
    pub timeout_seconds: u64,
    pub max_fix_attempts: u32,
    pub error_analysis_depth: crate::saca::types::ErrorAnalysisDepth,
    pub parallel_execution: bool,
...
impl Default for ExecuteConfig {
    fn default() -> Self {
        Self {
            execution_strategy: crate::saca::types::ExecutionStrategy::Adaptive,
            timeout_seconds: 30,
            max_fix_attempts: 3,
            error_analysis_depth: crate::saca::types::ErrorAnalysisDepth::Medium,
            parallel_execution: true,
...
pub struct RerankConfig {
    pub criteria: crate::saca::types::RerankingCriteria,
...
impl Default for RerankConfig {
    fn default() -> Self {
        Self {
            criteria: crate::saca::types::RerankingCriteria::default(),
