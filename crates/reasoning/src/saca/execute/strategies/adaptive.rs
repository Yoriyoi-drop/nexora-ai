...
impl AdaptiveExecutionStrategy {
    pub async fn execute(
        ...
        match execution_mode {
            ...
            ExecutionMode::Hybrid => Self::execute_hybrid(engine, candidates, context).await,
        }
    }
    ...
    async fn execute_hybrid(
        ...
        let sequential_results =
            SequentialExecutionStrategy::execute(engine, sequential_candidates, context).await?;
