...
impl KronosCapabilities {
    ...
    fn create_capability_vector() -> CapabilityVector {
        CapabilityVector::new(NxrModelId::Kronos)
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Knowledge, CapabilityLevel::Expert)
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Simulation, CapabilityLevel::Intermediate)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Decision, CapabilityLevel::Intermediate)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Mathematics, CapabilityLevel::Basic)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Strategy, CapabilityLevel::Intermediate)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Security, CapabilityLevel::Intermediate)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Monitoring, CapabilityLevel::Advanced)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Multimodal, CapabilityLevel::Basic)
                    .with_sub_capabilities(vec![
    ...
    pub fn validate(&self) -> Result<(), String> {
        ...
        let core_domains = vec![CapabilityDomain::Knowledge, CapabilityDomain::Text];
