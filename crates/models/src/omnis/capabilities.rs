...
impl OmnisCapabilities {
    ...
    fn create_capability_vector() -> CapabilityVector {
        CapabilityVector::new(NxrModelId::Omnis)
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Emotional, CapabilityLevel::Expert)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Strategy, CapabilityLevel::Transcendent)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Knowledge, CapabilityLevel::Transcendent)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::SelfImprovement, CapabilityLevel::Advanced)
                    .with_sub_capabilities(vec![
