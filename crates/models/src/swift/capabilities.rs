...
impl SwiftCapabilities {
    ...
    fn create_capability_vector() -> CapabilityVector {
        CapabilityVector::new(NxrModelId::Swift)
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Orchestration, CapabilityLevel::Expert)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Simulation, CapabilityLevel::Advanced)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Decision, CapabilityLevel::Advanced)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Knowledge, CapabilityLevel::Intermediate)
                    .with_sub_capabilities(vec![
            ...
            .with_capability(
                CapabilitySpec::new(CapabilityDomain::Monitoring, CapabilityLevel::Expert)
                    .with_sub_capabilities(vec![
