...
impl ApiClient {
    ...
    pub async fn process_request(&self, request: ProcessRequest) -> Result<ProcessResponse> {
        ...
        let response = self
            .make_request(reqwest::Method::POST, "process", Some(body))
            .await?;
    ...
    pub async fn generate_text(&self, request: GenerateRequest) -> Result<GenerateResponse> {
        ...
        let body = serde_json::to_value(request)?;
        let response = self
            .make_request(reqwest::Method::POST, "generate", Some(body))
            .await?;
    ...
    pub async fn chat(&self, request: ChatRequest) -> Result<ChatResponse> {
        let truncated = if request.message.len() > 100 {
            format!(
                "{} [truncated {} chars]",
                &request.message[..100],
                request.message.len()
        ...
        info!(
            ...
            truncated, request.conversation_id
        );

        let body = serde_json::to_value(request)?;
        let response = self
            .make_request(reqwest::Method::POST, "chat", Some(body))
            .await?;
    ...
    pub async fn analyze_code(&self, request: AnalyzeCodeRequest) -> Result<AnalyzeCodeResponse> {
        ...
        let body = serde_json::to_value(request)?;
        let response = self
            .make_request(reqwest::Method::POST, "code/analyze", Some(body))
            .await?;
    ...
    pub async fn generate_code(
        ...
        let body = serde_json::to_value(request)?;
        let response = self
            .make_request(reqwest::Method::POST, "code/generate", Some(body))
            .await?;
    ...
    pub async fn get_system_info(&self) -> Result<Value> {
        ...
        let response = self
            .make_request(reqwest::Method::GET, "info", None)
            .await?;
